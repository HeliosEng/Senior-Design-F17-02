...
#Stage_Controls.Home_All_Devices(deviceY, deviceZ, deviceR)
...
if question == "Y":
    ...
    Stage_Controls.abs_move(deviceX, Stage_Constants.Xalignedtostage) #
    Stage_Controls.abs_move(deviceY, (Stage_Constants.Ystagelevel)) # add  "+ int(85*Stage_Constants.conv_YZ" for mirror height 
