...
def Take_Data(file_name):
    ...
    Samples_Per_Ch_To_Read = 14000 # This number divided by Samples_Per_Second is the seconds of data that you collect. This is also the TOTAL number of samples you will end up with.
